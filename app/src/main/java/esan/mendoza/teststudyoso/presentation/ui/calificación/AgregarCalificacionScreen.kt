...
import esan.mendoza.teststudyoso.domain.model.Curso
...
fun AgregarCalificacionScreen(
    ...
    Column(
        ...
        ExposedDropdownMenuBox(
            ...
            OutlinedTextField(
                value = pruebaSeleccionada?.nombreTipo ?: "",
                onValueChange = {},
                readOnly = true,
        ...
        ExposedDropdownMenuBox(
            ...
            ExposedDropdownMenu(
                ...
                List(pruebaSeleccionada?.cantidadPruebas ?: 0) { index ->
                    val numero = index + 1
                    DropdownMenuItem(
